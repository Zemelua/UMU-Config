...
import io.github.zemelua.umu_config.old.api.client.gui.entry.EnumConfigEntry;
...
public class EnumConfigValueOldOld<T extends Enum<T>> extends AbstractConfigValueOldOld<T> implements IEnumConfigValue<T> {
	private final Class<T> clazz;

	public EnumConfigValueOldOld(Identifier ID, T defaultValue) {
	...
	public static class Builder<E extends Enum<E>> {
		...
		public EnumConfigValueOldOld<E> build() {
			return new EnumConfigValueOldOld<>(this.ID, this.defaultValue);
		}
	}
}
