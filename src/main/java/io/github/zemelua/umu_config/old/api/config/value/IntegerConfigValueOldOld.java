...
public class IntegerConfigValueOldOld extends AbstractNumberConfigValueOldOld<Integer> {
	public IntegerConfigValueOldOld(Identifier ID, Integer defaultValue, Integer maxValue, Integer minValue, Function<Integer, Text> textGenerator) {
	...
	public static class Builder {
		...
		public IntegerConfigValueOldOld build() {
			return new IntegerConfigValueOldOld(this.ID, this.defaultValue, this.maxValue, this.minValue, this.textGenerator);
		}
	}
}
