...
import io.github.zemelua.umu_config.old.api.client.gui.entry.NumberConfigEntry;
...
public abstract class AbstractNumberConfigValueOldOld<T extends Number> extends AbstractConfigValueOldOld<T> implements INumberConfigValue<T> {
	protected final T maxValue;
	protected final T minValue;
	protected final Function<T, Text> textGenerator;

	protected AbstractNumberConfigValueOldOld(Identifier ID, T defaultValue, T maxValue, T minValue, Function<T, Text> textGenerator) {
