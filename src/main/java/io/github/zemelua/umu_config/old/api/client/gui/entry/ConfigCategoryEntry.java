...
public class ConfigCategoryEntry extends AbstractConfigEntry {
	...
	private final OldIConfigCategory category;

	private boolean isFolded;

	public ConfigCategoryEntry(AbstractConfigScreen.ValueListWidget parent, OldIConfigCategory category, int indent, boolean readOnly) {
		super(indent);
