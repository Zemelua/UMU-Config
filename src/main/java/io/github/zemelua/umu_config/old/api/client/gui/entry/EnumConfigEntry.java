...
import io.github.zemelua.umu_config.old.api.config.value.IEnumConfigValue;
...
public class EnumConfigEntry<T extends Enum<T>, V extends OldOldIConfigValue<T> & IEnumConfigValue<T>> extends AbstractConfigValueEntry<T, V> {
