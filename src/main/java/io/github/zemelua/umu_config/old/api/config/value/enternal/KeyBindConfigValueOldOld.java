...
import io.github.zemelua.umu_config.old.api.client.gui.entry.KeyBindConfigEntry;
...
public class KeyBindConfigValueOldOld implements OldOldIKeyBindConfigValue {
	private final Identifier ID;
	private final Supplier<KeyBinding> keyBinding;

	public KeyBindConfigValueOldOld(Identifier ID, Supplier<KeyBinding> keyBinding) {
		this.ID = ID;
