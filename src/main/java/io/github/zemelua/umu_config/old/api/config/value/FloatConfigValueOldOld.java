...
public class FloatConfigValueOldOld extends AbstractNumberConfigValueOldOld<Float> {
	public FloatConfigValueOldOld(Identifier ID, Float defaultValue, Float maxValue, Float minValue, Function<Float, Text> textGenerator) {
	...
	public static class Builder {
		...
		public FloatConfigValueOldOld build() {
			return new FloatConfigValueOldOld(this.ID, this.defaultValue, this.maxValue, this.minValue, this.textGenerator);
		}
	}
}
