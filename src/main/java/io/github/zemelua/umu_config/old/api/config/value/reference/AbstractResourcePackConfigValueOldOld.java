...
public abstract class AbstractResourcePackConfigValueOldOld extends AbstractReferenceConfigValueOldOld<Boolean> implements IBooleanConfigValue {
	protected final Identifier ID;
	protected final String packName;

	protected Boolean value;

	public AbstractResourcePackConfigValueOldOld(Identifier ID, String packName) {
		this.ID = ID;
