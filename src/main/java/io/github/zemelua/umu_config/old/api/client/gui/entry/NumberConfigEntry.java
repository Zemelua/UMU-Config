...
import io.github.zemelua.umu_config.old.api.config.value.INumberConfigValue;
import net.minecraft.client.gui.DrawContext;
import net.minecraft.client.gui.widget.SliderWidget;
import net.minecraft.text.Text;
import net.minecraft.util.math.MathHelper;

public class NumberConfigEntry<T extends Number, V extends OldOldIConfigValue<T> & INumberConfigValue<T>> extends AbstractConfigValueEntry<T, V> {
