...
public abstract class AbstractListConfigValue<E> extends AbstractConfigValue<List<E>> {
	private final int nbtType;

	public AbstractListConfigValue(Identifier ID, int nbtType, E... defaultValues) {
